...
const goToPage = () => router.push({ name: 'JournalBanque' })
...
<template>
  <div class="p-4 sm:p-6 space-y-5">
    ...
    <div class="flex items-center justify-between gap-3 flex-wrap">
      <div class="min-w-0">
        <h1 class="text-xl font-semibold text-foreground truncate">Saisie — Journal Banque</h1>
        <p class="text-sm text-muted-foreground mt-0.5 hidden sm:block">
          Journal : BANQUES / {{ form.numPiece }}
        </p>
      </div>
